...
\begin{figure}
	...
	\caption{The region \([20,60] \times [-30,10]\) in \Cref{fig:n10m0-paths}. The curvature of the path can clearly be seen.}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{N10M0_p_err}
